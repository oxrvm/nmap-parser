...
def main():
    ...
    nmap_settings_directory = os.path.join(
        f'{current_working_directory}', 'settings')
    if not os.path.isdir(nmap_settings_directory):
        os.makedirs(nmap_settings_directory)

    nmap_results_directory = os.path.join(
        f'{current_working_directory}', 'results')
    if not os.path.isdir(nmap_results_directory):
        os.makedirs(nmap_results_directory)

    nmap_network_file = os.path.join(nmap_settings_directory, 'network.txt')
    nmap_results_file = os.path.join(nmap_results_directory, 'results.xml')
